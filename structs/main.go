...
func main() {
	...
	lastBook := book{"The Davinci Code", "Dan Brown", 2003} //this is a struct literal and order matters
	fmt.Println(lastBook)

	// Declaring a new book value by specifying field: value (order doesn't matter)
	bestBook := book{title: "Cosmos", author: "Carl Sagan", year: 1980}
	_ = bestBook
	...
	fmt.Println(lastBook.title) // => The Davinci Code
	...
	// updating a field
	lastBook.author = "Michelangelo"
	lastBook.year = 2020
	fmt.Printf("lastBook: %+v\n", lastBook) // => lastBook: {title:The Davinci Code author:Michelangelo year:2020}
